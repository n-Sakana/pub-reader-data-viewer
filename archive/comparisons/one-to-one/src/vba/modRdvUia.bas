Attribute VB_Name = "modRdvUia"
'==============================================================================
' modRdvUia -- Excel VBA as a UI Automation CLIENT, watching Notepad.
'
...
Public Function RdvUiaWhy() As String
    RdvUiaWhy = m_Why
End Function

Public Function RdvUiaBound() As Boolean
    RdvUiaBound = Not (m_Val Is Nothing)
End Function

Public Function RdvUiaHwnd() As Variant
    RdvUiaHwnd = m_Hwnd
End Function

Public Function RdvUiaTitle() As String
    RdvUiaTitle = m_Title
End Function

Public Sub RdvUiaReset()
    Set m_Val = Nothing
    Set m_Doc = Nothing
    m_Hwnd = 0
    m_Title = ""
...
' Same rule as RdvWatch.Bind() in the C# builds -- Notepad windows only, the
...
Public Function RdvUiaBind() As Boolean
    ...
    m_Why = "find"
    fg = RdvForegroundWindow()
    h = 0
    Do
        h = RdvFindWindowEx(0, h, "Notepad", vbNullString)
        If h = 0 Then Exit Do
        If RdvIsWindowVisible(h) <> 0 Then
            hLast = h
...
Public Function RdvUiaRead() As Variant
    On Error GoTo Fail
    If m_Val Is Nothing Then
        RdvUiaRead = Null
        Exit Function
    End If
    RdvUiaRead = m_Val.CurrentValue
    Exit Function
Fail:
    RdvUiaReset
    RdvUiaRead = Null

...
public static class Rdv3Uia
{
    ...
    // the (small) result.
    private static System.Windows.Automation.Condition ToCondition(Rdv3Match m)
    {
        List<System.Windows.Automation.Condition> parts = new List<System.Windows.Automation.Condition>();
        ...
        {
            List<System.Windows.Automation.Condition> ors = new List<System.Windows.Automation.Condition>();
        ...
        if (parts.Count == 0) { return System.Windows.Automation.Condition.TrueCondition; }

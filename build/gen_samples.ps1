# ============================================================================
# gen_samples.ps1 -- realistic dummy data for the five sample definitions
# under build\samples: a set of CSVs + the settings.json + expected.txt (the
...
if ([string]::IsNullOrEmpty($OutDir)) { $OutDir = Join-Path $Root 'build\out\samples' }
$srcSamples = Join-Path $Root 'build\samples'

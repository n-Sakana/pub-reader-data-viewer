...
同梱のサンプルデータ (100,000 行) で検索を試すときは、番号1 に次の 8 桁を入れます (完全一致)。

| 番号1 | ヒット件数 |
|---|---|
| `00000001` 〜 `00001000` | 5 件 (候補一覧が開く) |
| `00001001` 〜 `00006000` | 3 件 (候補一覧が開く) |
| `00006001` 〜 `00021000` | 2 件 (候補一覧が開く) |
| `00021001` 〜 `00071000` | 1 件 (そのまま表示) |
| `00071001` 以降 | 0 件 (「見つかりません」) |
